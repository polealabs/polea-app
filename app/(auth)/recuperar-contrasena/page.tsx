      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0D0D0D] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="font-serif text-4xl font-medium text-white leading-tight mb-6">
            Sin estrés,
            <br />
            <span className="text-[#4A90D9]">sin bloqueos.</span>
          </h2>
        ...
        <div className="w-full max-w-sm">
          ...
          {enviado ? (
            <div className="text-center">
              ...
              <p className="text-[#4A463C] text-sm mb-6">
                Te enviamos un enlace para restablecer tu contraseña. Puede tardar unos minutos.
              </p>
              <Link href="/login" className="text-sm text-[#4A90D9] font-semibold hover:underline">
            ...
            <>
              ...
              <p className="text-[#4A463C] text-sm mb-8">
